  ...
  <!-- header -->
   ...
   <header class="main-header clearfix" role="header"> 
      ...
      <div class="logo">
         <p class="bienvenido">
            <a href="index.html">
               <img src="assets/images/logo-universidad-popular-del-cesar.png " width="10%"  alt="Logo" style="color: black;">
            </a>
            <?php
               $usuarioMayus = strtoupper($usuario);
               echo "<h5>BIENVENIDO USUARIO $usuarioMayus </h5>";  
            ?> 
         </p>
      </div>
      ...
      <nav id="menu" class="main-nav" role="navigation">
         ...
         <ul class="main-menu">
            <li> 
               <a href="" class="external" style="background-color: rgb(60, 155, 97, 0.9); color: bisque;" >
               Cerrar sesión
               </a>
            </li>
         </ul>
